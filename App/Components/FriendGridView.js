...
class FriendGridView extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      ...
      numColumns={2}
       ...
       renderItem ={({item}) => (
        ...
        <CardItem cardBody>
          <Image source={{uri: item.picture.thumbnail}} style={{height: 200,borderRadius: 0, width: null, flex: 1}}/>
        </CardItem>
        <CardItem>
          <Left>
            <Button transparent>
